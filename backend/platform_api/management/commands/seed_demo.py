...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        all_permissions = ['home.view','automation.view','automation.create','automation.run','automation.edit','automation.delete','monitor.api.view','monitor.api.manage','monitor.task.view','monitor.task.manage','monitor.task.run','monitor.alarm.view','monitor.alarm.handle','environment.view','environment.manage','users.view','users.manage','users.status','users.delete','roles.view','roles.manage','roles.grant','roles.delete']
