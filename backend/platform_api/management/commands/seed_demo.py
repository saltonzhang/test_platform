...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        all_permissions = ['home.view','data_factory.view','data_factory.account_add','data_factory.account_balance','data_factory.order_result_push','data_factory.rollback_settlement','data_factory.bet_cancel','data_factory.rollback_bet_cancel','automation.view','automation.create','automation.run','automation.edit','automation.delete','monitor.api.view','monitor.api.manage','monitor.task.view','monitor.task.manage','monitor.task.run','monitor.alarm.view','monitor.alarm.handle','environment.view','environment.manage','users.view','users.manage','users.status','users.delete','roles.view','roles.manage','roles.grant','roles.delete']
        ...
        for code, name, permissions in [
            ('test_lead','测试负责人',['home.view','automation.view','automation.create','automation.run','automation.edit','automation.delete','monitor.api.view','monitor.api.manage','monitor.task.view','monitor.task.manage','monitor.task.run','monitor.alarm.view','monitor.alarm.handle','environment.view','environment.manage','users.view']),
            ('tester','测试工程师',['home.view','automation.view','automation.create','automation.run','automation.edit','monitor.api.view','monitor.task.view','monitor.task.run','monitor.alarm.view','environment.view']),
            ('viewer','只读成员',['home.view','automation.view','monitor.api.view','monitor.task.view','monitor.alarm.view','environment.view']),
        ]:
