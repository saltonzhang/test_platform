...
const form=reactive({environment:0,email:'',amount:0})
const rules:FormRules={environment:[{required:true,message:'请选择后台环境'}],email:[{required:true,message:'请输入会员邮箱'},{type:'email',message:'邮箱格式不正确'}],amount:[{required:true,message:'请输入加款金额'}]}
